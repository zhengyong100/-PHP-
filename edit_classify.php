        ...
        <td align="left" valign="top">
            ...
            if ($_GET[Submit]) {
                ...
                if ($query) {
                    ...
                    echo "修改分类名称，执行数据库操作时失败！</td></tr></table> 2秒后自动返回<meta http-equiv=refresh content='2; url=classify.php'>";
                    exit();
                }
            }
            //执行操作--转移分类
            ...
            if ($_GET[Submit3]) {
                ...
                if ($row = mysqli_fetch_array($query)) {
                    ...
                    if (mysqli_query($conn,$sql))
                        ...
                        echo "<font color='red'>删除失败！从数据库中删除时返回失败！</font></td></tr></table> 2秒后自动返回<meta http-equiv=refresh content='2; url=classify.php'>";
                    exit();
                }
            }
            //根据操作判断要显示内容
                ...
                <table align="center" width="600" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td><form id="form1" name="form1" method="get" action="">
                            <label>将[<font color="red"><?php echo $cuclass[classname];
                                ?></font>]修改为
                ...
                <table align="center" width="600" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td><form id="form2" name="form2" method="get" action="">
                            将[<font color="red"><?=$cuclass[classname] ?></font>]
                            <label>转移到
