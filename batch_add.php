...
if ($_GET[Submit]) {
    ...
    foreach ($path as $key => $value) {
        ...
        $query = mysqli_query($conn,"insert into ".$qianzui."account (acmoney, acclassid, actime, acremark,zhifu,jiid) values('$value','".$path1[$key]."','$time100','".$path3[$key]."','".$path4[$key]."','$_SESSION[uid]')");
